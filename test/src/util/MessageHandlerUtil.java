...
public class MessageHandlerUtil {
    ...
    private static String handleTextMessage(Map<String, String> map) {
        ...
        switch (content) {
            case "文本":
                String msgText = "殷乾广又要开始学习了\n" +
                        "<a href=\"http://ifeve.com/java-concurrency-thread-directory\">殷乾广学习内容</a>";
                responseMessage = buildTextMessage(map, msgText);
                break;
            case "图片":
                //通过素材管理接口上传图片时得到的media_id
                String imgMediaId = "OBbACXZi2lR93bPaKXYVdPDAhnGcG2-Fyn2my46YKHC4dRrZIRuWQjgWvZfC7imd";
                responseMessage = buildImageMessage(map, imgMediaId);
                break;
            case "语音":
                //通过素材管理接口上传语音文件时得到的media_id
                String voiceMediaId = "7GWevOfL4LjjY0_XrzqSbUrpJFja4iaqnAINIlTWZUUckw4aIG5UmjPpYoKy9Tvu";
          ...
          //  case "图文":
           //     responseMessage = buildNewsMessage(map);
            ...
            case "音乐":
                ...
                music.musicUrl = "http://5jmftm.natappfree.cc//test//web//media//music//music.mp3";
                music.hqMusicUrl = "http://5jmftm.natappfree.cc//test//web//media//music//music.mp3";
                responseMessage = buildMusicMessage(map, music);
                break;
            case "视频":
                Video video = new Video();
                video.mediaId = "CPZ_ekiwNkI3JDrWDBMrTx-_F2na7qpT-MrR9SiKNcoYOVZ2D2WaIleaQT_NnPbf";
                video.title = "小苹果";
    ...
    private static String buildWelcomeTextMessage(Map<String, String> map) {
        ...
        responseMessageXml = String
                .format(
                        ...
                        "感谢您关注殷乾广的个人公众号，请回复如下关键词来使用公众号提供的服务：\n文本\n图片\n语音\n视频\n音乐\n图文");
        return responseMessageXml;
    }
